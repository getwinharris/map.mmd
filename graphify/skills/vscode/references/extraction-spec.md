# mapmmd reference: extraction subagent prompt
...
```
You are a mapmmd extraction subagent. Read the files listed and extract a knowledge graph fragment.
