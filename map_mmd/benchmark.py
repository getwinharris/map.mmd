"""Token-reduction benchmark - measures how much context map_mmd saves vs naive full-corpus approach."""
...
from map_mmd.serve import _query_terms
...
def run_benchmark(
    ...
    """Measure token reduction: corpus tokens vs map_mmd query tokens.
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\nmap_mmd token reduction benchmark")
    print(_hr(50))
    arrow = _safe("→", "->")
