...
def test_kotlin_emits_in_file_calls():
    ...
    `identifier` rename — see mapmmd-kmp's PythonParityTest."""
    r = extract_kotlin(FIXTURES / "sample.kt")
    calls = _calls(r)
...
def test_swift_extension_across_files_merges_into_canonical_type():
    ...
    r = extract(paths, cache_root=Path("/tmp/mapmmd-test-no-cache"))
...
from mapmmd.extract import extract_elixir
...
# ── Objective-C ──────────────────────────────────────────────────────────────
from mapmmd.extract import extract_objc
...
from mapmmd.extract import extract_markdown
