...
def _log_path() -> Path | None:
    if os.environ.get("MAPMMD_QUERY_LOG_DISABLE", "").lower() in ("1", "true", "yes"):
        return None
    override = os.environ.get("MAPMMD_QUERY_LOG", "").strip()
    if override:
...
def _log_responses() -> bool:
    return os.environ.get("MAPMMD_QUERY_LOG_RESPONSES", "").lower() in ("1", "true", "yes")
