...
googleworkspace CLI (`gws`) so mapmmd can extract their actual contents.
"""
...
def google_workspace_enabled(value: str | None = None) -> bool:
    ...
    raw = value if value is not None else os.environ.get("MAPMMD_GOOGLE_WORKSPACE", "")
...
def _run_gws_export(file_id: str, mime_type: str, output: Path, resource_key: str | None = None) -> None:
    ...
    timeout = int(os.environ.get("MAPMMD_GOOGLE_WORKSPACE_TIMEOUT", "120"))
