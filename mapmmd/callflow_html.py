...
def infer_project_name(graph_path: str, meta: dict) -> str:
    ...
    if path.parent.name == MAPMMD_OUT_NAME and len(path.parents) > 1:
...
def resolve_mapmmd_paths(args) -> dict:
    ...
    if args.mapmmd_out:
        ...
        mapmmd_out = base / MAPMMD_OUT

    project_root = mapmmd_out.parent if mapmmd_out.name == MAPMMD_OUT_NAME else base
