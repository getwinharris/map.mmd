...
```powershell
$PROJECT_ROOT = (Get-Location).Path  # cwd — where Part C globs mapmmd-out\ (NOT .mapmmd_root/scan dir, #1392)
# Then for chunk N: $CHUNK_PATH = Join-Path $PROJECT_ROOT "mapmmd-out\.mapmmd_chunk_0N.json"
```
