# map.mmd reference: extraction subagent prompt
...
```
You are a map.mmd extraction subagent. Read the files listed and extract a knowledge graph fragment.
